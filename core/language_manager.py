class LanguageManager:
    ...
    TRANSLATIONS = {
        ...
        "zh-CN": {
            ...
            "eye_find.help.tip": "让两个图案都清晰并重合后，点击确认。",
            "eye_find.help.title": "怎么玩？",
            "eye_find.help.step1": "先选训练模式（裸眼/红蓝眼镜），红蓝模式要选滤镜方向并佩戴眼镜哦～",
            "eye_find.help.step2": "眼睛看着左右两个图案，慢慢聚焦，让两个都变清晰（同时看到）",
            "eye_find.help.step3": "看到两个图案都清晰后，点击确认，会切换新图案继续哦！",
            ...
            "eye_find.confirm": "确认",
            "eye_find.success": "太棒啦！切换新图案～ +10",
            "eye_find.fail": "再试试，让两个图案都清晰～",
            "eye_find.result.title": "训练时间到啦！",
