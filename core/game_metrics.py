...
METRIC_LABEL_KEYS = {
    ...
    "depth_order_accuracy": "pop_nearest.metric.label",
    "correct_pops": "metric.correct_pops",
    "wrong_pops": "metric.wrong_pops",
    "avg_pop_time": "pop_nearest.metric.avg_pop_time",
    "groups_cleared": "pop_nearest.metric.groups",
